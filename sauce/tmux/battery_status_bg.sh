...
color_full_charge="$normalblue"
color_high_charge="$normalgreen"
color_medium_charge="$normalyellow"
color_low_charge="$normalred"

get_charge_color_settings() {
    color_full_charge=$(get_tmux_option "@batt_color_full_charge" "$color_full_charge")
    color_high_charge=$(get_tmux_option "@batt_color_high_charge" "$color_high_charge")
    color_medium_charge=$(get_tmux_option "@batt_color_medium_charge" "$color_medium_charge")
    color_low_charge=$(get_tmux_option "@batt_color_low_charge" "$color_low_charge")
}
