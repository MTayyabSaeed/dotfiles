...
color_full_charge_default="black"
color_high_charge_default="black"
color_medium_charge_default="black" # orange
color_low_charge_default="black"
color_charging_default="black"
